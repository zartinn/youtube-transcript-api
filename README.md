...
0. remove `dist` and `package/python` folder
1. `mkdir package/python`
2. `python3 -m build`
3. `pip3 install --target package/python dist/youtube_transcript_api-0.6.2-py3-none-any.whl`
4. `cd package`
5. `zip -r lambda-layer.zip python`
